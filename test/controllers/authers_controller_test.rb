...
class AuthersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auther" do
    assert_difference('Auther.count') do
      post authers_url, params: { auther: { first_name: @auther.first_name, last_name: @auther.last_name, title: @auther.title } }
    end
  ...
  test "should update auther" do
    patch auther_url(@auther), params: { auther: { first_name: @auther.first_name, last_name: @auther.last_name, title: @auther.title } }
